...
% (s19-23) - does not produce figures but creates the bootstrat statistics
...
integ_dur = 0.3;
smoothness = 30;
%19-23 is the basic iconic worth design.

Sessions = 19:23;%15:16;%15:19;%17:18;%15:16;%9:11;%[3:4]; %7:
...
figure; hist(EstimWorthBehav(1:bst)- EstimWorthNeuronalAllChan(1:bst), 20)
